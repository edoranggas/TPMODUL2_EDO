public class Handphone extends Perangkat {
    ...
    public void informasi(){
        if (fingerprint == true){
            ...
            System.out.println("Handphone ini memiliki drive tipe " + drive + "dengan ram sebesar " + ram + "GB dan processor secepat "+ processor+ "Selain itu laptop ini juga TIDAK memiliki Webcam");   
        }
    }

    public void telfon(int no_hp){
        System.out.println("Handphone berhasil menyambungkan telfon ke nomot "+ no_hp);
    }
